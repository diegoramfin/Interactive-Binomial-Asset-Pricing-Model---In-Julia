...
#
# It then prints the valuation summary, enumerates every path-dependent price
# path, draws terminal graphs of the recombining tree and all paths up to the
# final period, and (when Plots.jl is available) writes PNGs to output/.
